...
const HomeLayout = () => {
	...
	const fetchProfile = async () => {
		try {
			const data: UserProfile = await axiosPrivate
				.get<UserProfile>("/business-owner/me")
				.then((res) => res.data);
			...
			console.log("dataBussiness", dataBussiness);
			...
			screenOptions={({ route }: { route: { name: string } }) => ({
				header:
					route.name === "ReportScreen"
						...
						: (props: React.ComponentProps<typeof HeaderNavigation>) => (
